...
const AddressForm = ({formVisiblitity, setFormVisiblitity}) => {
        ...
        <div className="w-full max-w-md space-y-8 ">
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              <h1 className="text-2xl font-bold mt-2">Add  a new address</h1>
            </div>
          </div>
          ...
          <button type="submit" className="btn btn-error w-full" onClick={() => (setFormVisiblitity(!formVisiblitity))}>Cancel</button>
        </div>
      </div>
    </div>
  )
